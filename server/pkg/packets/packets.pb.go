...
const file_packets_proto_rawDesc = "" +
	...
	"\x01y\x18\x04 \x01(\x01R\x01y\"\xc7\x03\n" +
	"\x06Packet\x12\x1b\n" +
	...
	"\x06player\x18\b \x01(\v2\x16.packets.PlayerMessageH\x00R\x06playerB\x05\n" +
